...
`@tetherto/wdk-failover-provider`. This is a real, defensible operational limit, not fake parity, and it is the only thing between the shipped code and a
running BTC wallet.
...
in First Load). Current First Load: Next ≈ 240 kB, Svelte main ≈ 226 kB. The
