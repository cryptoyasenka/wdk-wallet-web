...
UI shell brings First Load to ≈234 kB — see "First Load JS" below.
...
BTC. Current First Load: Next ≈ 234 kB, Svelte main ≈ 226 kB — both grew from
...
`@tetherto/*` (Next First Load JS ≈ 234 kB; no `@tetherto/*` in it before or
