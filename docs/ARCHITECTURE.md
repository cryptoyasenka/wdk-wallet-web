...
UI shell brings First Load to ≈239 kB. See "First Load JS" below.
...
BTC. Current First Load: Next ≈ 239 kB, Svelte main ≈ 226 kB; both grew from
...
`@tetherto/*` (Next First Load JS ≈ 239 kB; no `@tetherto/*` in it before or
